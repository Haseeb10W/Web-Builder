...
export default function Transition({props,change}: settingFieldProps) {
  ...
  return (
    <>
    <SelectField props={props} change={(value:any)=>handleTransitionChange(value)}/>
    { props?.tabOpen && transition !== "" &&
    (
        <>
        {transition == "custom" && (
            <>
            <TextField props={custom} change={(value:any)=>handleCustumValue(value)}/>
            </>
        )}
         <Zindex props={transitionDelay} change={(value:any)=>handleTransitionDelay(value)}/>
         <Zindex props={transitionDuration} change={(value:any)=>handleTransitionDuration(value)}/>
         <SelectField props={TimmingEffect} change={(value:any)=>handleTimmingEffects(value)}/>
        </>
    )
    }
