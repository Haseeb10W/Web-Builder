...
import { placeholder } from "jodit/esm/plugins/placeholder/placeholder"
 ...
 const iconListSettings:settingsSetupSchema = {
  ...
  content : [
    /* +++++++++++++++++  Content Text +++++++++++++++++++++++*/
   // 0 
    setSettingField('heading',{label: "Icon List", for : 'iconlist', tabOpen: true, tabAllow: false}),
...
export const iconListSettindsSet:settingsSetArgs = (settingType, data, screenType)=> {
  ...
  if(findBlock){
    const settings = {...iconListSettings}
